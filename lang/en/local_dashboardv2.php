...
$string['feedback_management'] = 'Feedback Management';
$string['select_course'] = 'Select Course';
$string['choose_course'] = '-- Choose Course --';
$string['select_feedback'] = 'Select Feedback';
$string['choose_feedback'] = '-- Choose Feedback --';
$string['feedback_responses'] = 'Feedback Responses';
$string['response_date'] = 'Response Date';
$string['no_feedback_responses'] = 'No feedback responses found.';
$string['no_feedback_activities'] = 'No feedback activities found in this course.';
$string['select_manager_course_feedback'] = 'Select manager, course and feedback to view responses.';