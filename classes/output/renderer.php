...
class renderer extends plugin_renderer_base {
     ...
     */
    public function render_dashboard_feedbacks(dashboard_report $page)
    {

        // Export data and render template
        $data = $page->export_for_template($this);
        return $this->render_from_template('local_dashboardv2/feedbacks', $data);
    }

    public function render_module_progress(dashboard_report $page){
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_remui/edwiser_module_progress', $data);
    }

    public function render_quiz_progress(dashboard_report $page)
    {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_remui/edwiser_quiz_progress', $data);
    }
