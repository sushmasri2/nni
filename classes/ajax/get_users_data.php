        ...
        try {
            ...
            switch ($current_role) {
                case 'spoc':
                    ...
                    if ($area_manager) {
                        $users_data = user_hierarchy::get_users_under_area_manager_for_spoc($area_manager);
                    } else {
                ...
                case 'area_manager':
                    ...
                    if ($nutrition_officer) {
                        $users_data = user_hierarchy::get_users_under_nutrition_officer_for_area_manager($nutrition_officer);
                    } else {
